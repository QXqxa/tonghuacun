...
import { deletePhoto, listPhotos, uploadPhotos } from './supabase';

type Photo = { src: string; name: string; note: string; file?: File; path?: string };
